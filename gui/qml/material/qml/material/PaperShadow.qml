...
Item {
    ...
    states: [
        ...
        State {
            name: "z-1"
            PropertyChanges { target: topShadow; verticalOffset: 1 ; radius: 1.5 *12; color: "#1e000000" }
            PropertyChanges { target: bottomShadow; verticalOffset: 1 ; radius: 1 *12; color: "#3d000000" }
        },
        State {
            name: "z-2"
